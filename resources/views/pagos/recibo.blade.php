...
<script>
    ...
    function downloadPDF(btn) {
        ...
        const oldIframe = document.getElementById('scpm-receipt-iframe');
        if (oldIframe) oldIframe.remove();

        const iframe = document.createElement('iframe');
        iframe.id = 'scpm-receipt-iframe';
...
<head>
    <meta charset="utf-8">
    <title>Comprobante_Pago_Nro_{{ str_pad($pago->id, 5, '0', STR_PAD_LEFT) }}</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
        ...
        #receipt-card { width: 100% !important; max-width: 100% !important; margin: 0 !important; box-shadow: none !important; border: 1.5px solid #38bdf8 !important; border-radius: 10px !important; overflow: hidden !important; }
        .print-container { width: 100% !important; margin: 0 !important; padding: 0 !important; }
    </style>
</head>
<body class="bg-white">
